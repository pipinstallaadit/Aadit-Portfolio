  ...
  const contactLinks = [
    {
      icon: Mail,
      label: 'Email',
      value: 'aaditpujari@gmail.com',
      href: 'mailto:aaditpujari@gmail.com',
      color: 'text-red-500',
    ...
    },
    {
      icon: Phone,
      label: 'Phone',
      value: '+91 98675 43210',
      href: 'tel:+919867543210',
    ...
    },
    {
      icon: Linkedin,
      label: 'LinkedIn',
      value: 'linkedin.com/in/aadit-pujari',
      href: 'https://linkedin.com/in/aadit-pujari',
      color: 'text-blue-500',
    ...
    },
    {
      icon: Github,
      label: 'GitHub',
      value: 'github.com/aaditpujari',
      href: 'https://github.com/aaditpujari',
